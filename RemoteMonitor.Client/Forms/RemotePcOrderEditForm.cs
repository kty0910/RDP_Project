...
public sealed class RemotePcOrderEditForm : Form
{
    ...
    public IReadOnlyList<RemotePcInfo> RemotePcs => remotePcs;

    public RemotePcOrderEditForm(IEnumerable<RemotePcInfo> sourceRemotePcs)
    {
        remotePcs = sourceRemotePcs.ToList();
    ...
    private void ApplyListOrder()
    {
        ...
        {
            if (item is RemotePcInfo remotePc)
            {
